        ...
        <el-card class="box-card">
            ...
            <el-table border :data="list" style="width: 100%" highlight-current-row>
                ...
                <el-table-column label="所属地区" width="80">
                    <template slot-scope="{row}">
                        <e-select-view module="diqu" :value="row.suoshudiqu" select="id"
                            show="diqumingcheng"></e-select-view> </template>
                </el-table-column>
                    ...
                    <template slot-scope="{row}">
                        <el-button-group>
                            ...
                            <el-tooltip content="详情" placement="top">
                                <el-button @click="$goto({ path: '/admin/jingdianxinxidetail', query: { id: row.id } })"
                                    icon="el-icon-info" type="info" size="mini"></el-button>
                            </el-tooltip>
                            <el-tooltip content="编辑" placement="top">
                                <el-button icon="el-icon-edit"
                                    @click="$goto({ path: '/admin/jingdianxinxiupdt', query: { id: row.id } })" type="warning"
                                    size="mini"></el-button>
                            </el-tooltip>
