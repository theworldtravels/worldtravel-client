                    ...
                    <e-module-model-box title="景点列表">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="search-radio">
                                                ...
                                                <a href="javascript:;" v-for="r in mapdiqu4"
                                                    @click="selectRadio('suoshudiqu', r.id)"
                                                    :class="{ active: search.suoshudiqu == r.id }" v-text="r.diqumingcheng">
                                    ...
                                    <tr>
                                        <td class="label">
                                            景点名称 </td>
                                        <td>
                                            <el-input type="text" style="width: 150px" v-model="search.jingdianmingcheng"
                                                placeholder="请输入关键词">
                        ...
                        <el-row :gutter="30">
                            <el-col v-for="r in list" :md="6" :key="r.id" style="margin-bottom: 20px">
                                <e-module-xiezi :title="r.jingdianmingcheng" :image="r.tupian" :image-height="100"
                                    :is-scale="true" :to="'/jingdianxinxidetail?id=' + r.id">
