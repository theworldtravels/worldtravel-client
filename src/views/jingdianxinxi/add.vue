            ...
            <div class="form-database-form">
                ...
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    <el-form-item label="景点编号" prop="jingdianbianhao" :rules="[{ required: true, message: '请填写景点编号' }]">
                        <el-input placeholder="输入景点编号" style="width:250px;" v-model="form.jingdianbianhao" />
                    </el-form-item>

                    <el-form-item label="景点名称" prop="jingdianmingcheng" required
                        :rules="[{ required: true, message: '请填写景点名称' }]">
                        <el-input placeholder="输入景点名称" style="width:450px;" v-model="form.jingdianmingcheng" />
                    </el-form-item>
