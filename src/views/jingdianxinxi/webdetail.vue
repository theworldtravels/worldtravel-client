                                ...
                                <div class="goods-right-content">
                                    ...
                                    <div class="descount">
                                        <div>
                                            ...
                                            <span class="val">
                                                <e-select-view module="diqu" :value="map.suoshudiqu" select="id"
                                                    show="diqumingcheng"></e-select-view> </span>
                                        </div>
                                        <div>
                                            <span class="name">
                                                地址：
                                    ...
                                    <e-collect v-model="isCollect" module="jingdianxinxi" ziduan="jingdianmingcheng"
                                        :id="map.id"></e-collect>
