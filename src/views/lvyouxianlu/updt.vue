        ...
        <el-card class="box-card">
            ...
            <div class="form-database-form">
                ...
                <el-form :model="form" ref="formModel" label-width="130px" status-icon validate-on-rule-change>
                    ...
                    <el-form-item label="线路名称" prop="xianlumingcheng" required
                        :rules="[{ required: true, message: '请填写线路名称' }]">
                        <el-input placeholder="输入线路名称" style="width:450px;" v-model="form.xianlumingcheng" />
                    </el-form-item>
                    ...
                    <el-form-item label="价格" prop="jiage" required
